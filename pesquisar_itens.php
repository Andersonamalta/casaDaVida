...
?>
  ...
  <body id="page-top">
      ...
      <div style="background-color: #e3f2fd">
        ...
        <div class= "row p-2" >
          ...
          <div class="col-md-3" style="margin-top: 4.1px">
            <form class="form-inline my-2 my-lg-0" method="POST" action="pesquisar_itens.php">
      ...
      <?php
        ...
        $consulta = mysqli_query($conexao, "SELECT * FROM item WHERE descricao LIKE '%$pesquisa%' LIMIT 20");
            ...
            <form class="form-horizontal" method="POST" action="saida_item.php">
              ...
              <div class="form-group">
                <label class="col-md-1 control-label">Justificativa</label>
                  <div class="col-md-9">
                    <textarea id="justificativa" name="justificativa" placeholder="" class="form-control" maxlength="50" type="text"></textarea>
                  </div>
              </div>
