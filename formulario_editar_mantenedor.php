...
<body>
  ...
  <form class="form-horizontal" method="post" action="editar_mantenedor.php">
    <fieldset>
      ...
      <div style="background-color: #e3f2fd">
        ...
        <div class="panel-body"><br>
          ...
          <div class="form-group">
              <label class="col-md-1 control-label" for="pergunta1">Doacao: </label>
              <div class="col-md-3">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                ...
                <a href="mantenedores.php"><button id="Cancelar" name="Cancelar" class="btn btn-danger" type="button">Cancelar</button><a/>
              </div>
            </div>
