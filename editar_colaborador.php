<?php
	...
	$id_colaborador = filter_input(INPUT_POST, 'identificador', FILTER_SANITIZE_STRING);

	$sql = mysqli_query($conexao, "UPDATE colaboradores SET nome='$nome', cpf='$cpf', nascimento='$nascimento', sexo='$sexo', telefone='$telefone', whatsapp='$whatsapp', email='$email', cep='$cep', endereco='$endereco', numero='$numero', bairro='$bairro', cidade='$cidade', estado='$estado', redesocial='$redesocial', pergunta1='$pergunta1', timedecoracao='$time', pergunta2='$pergunta2', pergunta3='$pergunta3', observacao='$obs', modificado='$data', usuario='$usuario' WHERE id = '$id_colaborador'") or die
    ("erro na conexao");

    $aniversariantes = mysqli_query($conexao, "UPDATE aniversariantes SET nome='$nome', dataNascimento='$nascimento', whatsapp='$whatsapp' WHERE nome = '$nome'" );
