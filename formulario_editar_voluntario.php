...
<body>
  ...
  <form class="form-horizontal" method="post" action="editar_voluntario.php">
    <fieldset>
      ...
      <div style="background-color: #e3f2fd">
        ...
        <div class="panel-body"><br>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <input id="cpf" name="cpf" placeholder="Apenas números" value="<?php echo $row['cpf']; ?>" class="form-control input-md" type="text" onkeypress="$(this).mask('000.000.000-00');">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <div class="input-group">
                ...
                <input id="prependedtext" name="prependedtext" value="<?php echo $row['telefone']; ?>" class="form-control" placeholder="XX XXXXX-XXXX" type="text" onkeypress="$(this).mask('(00) 90000-0000')" >
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                <input id="prependedtext" name="whatsapp" class="form-control" value="<?php echo $row['whatsapp']; ?>" placeholder="XX XXXXX-XXXX" type="text" onkeypress="$(this).mask('(00) 90000-0000')">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <label class="col-md-3 control-label">Qual área de trabalho você mais se identifica ?</label>
              <div class="col-md-3">
                <input id="pergunta3" name="pergunta3" value="<?php echo $row['pergunta3']; ?>" class="form-control" placeholder="" type="text">
              </div>
          </div>
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">Dias disponíveis</label>
                  <div class="col-md-3">
                    <input id="dias" name="dias" value="<?php echo $row['dias']; ?>" class="form-control" placeholder="" type="text">
                  </div>

                  <label class="col-md-2 control-label">Horários disponíveis</label>
                   <div class="col-md-3">
                    <input id="horarios" name="horarios" value="<?php echo $row['horarios']; ?>" class="form-control" placeholder="" type=  "text">
                  </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                ...
                <a href="voluntarios.php"><button id="Cancelar" name="Cancelar" class="btn btn-danger" type="button">Cancelar</button><a/>
              </div>
            </div>
