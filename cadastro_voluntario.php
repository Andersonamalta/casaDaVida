<?php 
	...
	$horarios = filter_input(INPUT_POST, 'horarios', FILTER_SANITIZE_STRING);
	...
	$result_colaboradores = mysqli_query($conexao, "INSERT INTO voluntarios (nome, cpf, nascimento, sexo, telefone, whatsapp, email, cep, endereco, numero, bairro, cidade, estado, redesocial, pergunta1, timedecoracao, pergunta2, pergunta3, dias, horarios, observacao, criado, modificado, usuario) VALUES ('$nome', '$cpf', '$nascimento', '$sexo', '$telefone', '$whatsapp', '$email', '$cep', '$endereco', '$numero', '$bairro', '$cidade', '$estado', '$redesocial', '$pergunta1', '$time', '$pergunta2', '$pergunta3', '$dias', '$horarios', '$obs', '$data', '$modificado, '$usuario')");
