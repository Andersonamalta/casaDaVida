...
<body>
  ...
  <form class="form-horizontal" method="POST" action="cadastro_colaboradores.php">
    <fieldset>
      ...
      <div style="background-color: #e3f2fd">
        ...
        <div class= "row p-2" style="height: 60px;">
          ...
          <div class="col-md-4">  
            <h3 id="texto_colab" style="text-align: center; margin-top: 15px">Cadastro de Colaboradores</h3>
          </div>
        </div>
      </div>
        ...
        <div class="panel-body"><br>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <div class="input-group">
                ...
                <input id="prependedtext" name="prependedtext" class="form-control" placeholder="XX XXXXX-XXXX" type="text" maxlength="14" onkeypress="$(this).mask('(00) 90000-0000')">
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                <input id="prependedtext" name="whatsapp" class="form-control" placeholder="XX XXXXX-XXXX" type="text" maxlength="13" onkeypress="$(this).mask('(00) 90000-0000')">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <input id="cep" name="cep" placeholder="Apenas números" class="form-control input-md" value="" type="text" maxlength="8" onkeypress="$(this).mask('00.000-000')">
            </div>
          ...
          <div class="form-group">
            <label class="col-md-1 control-label" for="pergunta1">Doação de: </label>
              <div class="col-md-3">
                <input id="pergunta3" name="pergunta3" class="form-control" placeholder="" type="text">
              </div>        
          </div>
