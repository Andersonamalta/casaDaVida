...
<body>
  ...
  <?php
    ...
    $consulta = mysqli_query($conexao, "SELECT * FROM mantenedores WHERE id = '$id_mantenedor'");
    ...
    <fieldset>
      ...
      <div style="background-color: #1C81C8">
        ...
        <div class= "row p-2" style="height: 60px;" >
          ...
          <div class="col-md-1"> 
            <a href="mantenedores.php"><button type="button" class="btn btn-white " style="margin-top: 13px; float: right;"><i class="glyphicon glyphicon-chevron-left mr-2"></i> Voltar</button></a>
          </div>
      ...
      <div style="background-color: #e3f2fd">
        ...
        <div class="panel-body"><br>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <input id="cpf" name="cpf" placeholder="Apenas números" value="<?php echo $row['cpf']; ?>" class="form-control input-md" type="text" maxlength="14" onkeypress="$(this).mask('000.000.000-00');" disabled="disabled">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <div class="input-group">
                ...
                <input id="prependedtext" name="prependedtext" value="<?php echo $row['telefone']; ?>" class="form-control" placeholder="XX XXXXX-XXXX" type="text" maxlength="14" onkeypress="$(this).mask('(00) 90000-0000')" disabled="disabled">
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                <input id="prependedtext" name="whatsapp" class="form-control" value="<?php echo $row['whatsapp']; ?>" placeholder="XX XXXXX-XXXX" type="text" maxlength="13" onkeypress="$(this).mask('(00) 90000-0000')" disabled="disabled">
              </div>
            </div>
          </div>
          ...
          <div class="form-group"> 
              ...
              <label class="col-md-1 control-label" for="pergunta1">Doação </label>
              <div class="col-md-1">
                <input id="pergunta3" name="pergunta3" class="form-control" value="<?php echo $row['doacao']; ?>" placeholder="" type="text" disabled="disabled">
              </div>
