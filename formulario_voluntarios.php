...
<body>
  ...
  <form class="form-horizontal" method="POST" action="cadastro_voluntario.php">
    <fieldset>
      ...
      <div style="background-color: #e3f2fd">
        ...
        <div class= "row p-2" style="height: 60px;">
          ...
          <div class="col-md-4">  
            <h3 id="texto_colab" style="text-align: center; margin-top: 15px">Cadastro de Voluntários</h3>
          </div>
        </div>
      </div>
        ...
        <div class="panel-body"><br>
          ...
          <div class="form-group">
            ...
            <label class="col-md-3 control-label" for="pergunta2">Qual área de trabalho você mais se identifica ?</label>
              <div class="col-md-3">
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">Dias disponíveis</label>
                  <div class="col-md-3">
                    <input id="dias" name="dias" class="form-control" placeholder="" type="text">
                  </div>

                  <label class="col-md-2 control-label">Horários disponíveis</label>
                   <div class="col-md-3">
                    <input id="horarios" name="horarios" class="form-control" placeholder="" type=  "text">
                  </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                ...
                <a href="voluntarios.php"><button class="btn btn-danger" type="button">Cancelar</button><a/>
              </div>
            </div>
