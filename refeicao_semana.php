  ...
  <body id="page-top">
    ...
    <div style="background-color: #e3f2fd">
      ...
      <div class= "row p-2" >
        ...
        <div class="col-md-2">  
          <a href="controle_refeicoes.php"><i class="fa fa-chevron-left" aria-hidden="true" style="margin-top: 12px"></i></a>
        </div>
      </div>
    </div>
    ...
    <?php
      ...
      $consulta = mysqli_query($conexao, "SELECT * FROM semana_refeicao WHERE id_mes = '$id_mes' ORDER BY id ASC");
    ...
    <table class="table table-white">
      ...
      <tbody>
        ...
        <tr style="text-align: center;">
          <td><?php echo $row['segunda'];?></td>
          <td><?php echo $row['terca'];?></td>
          <td><?php echo $row['quarta'];?></td>
          <td><?php echo $row['quinta'];?></td>
          <td><?php echo $row['sexta'];?></td>
          <td><?php echo $row['total'];?></td>
          <td> <a href="formulario_editar_semana.php?&id=<?php echo $row['id'];?>"><button class="btn btn-warning" style="padding:5px"><i class="fa fa-edit"></i> Editar </button></a></td>
        </tr>
        <?php }?>
      </tbody>
