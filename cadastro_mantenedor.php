<?php 
	...
	$result_mantenedores = mysqli_query($conexao, "INSERT INTO mantenedores (nome, cpf, nascimento, sexo, telefone, whatsapp, email, cep, endereco, numero, bairro, cidade, estado, redesocial, pergunta1, timedecoracao, pergunta2, doacao, valor, observacao, criado, modificado, usuario) VALUES ('$nome', '$cpf', '$nascimento', '$sexo', '$telefone', '$whatsapp', '$email', '$cep', '$endereco', '$numero', '$bairro', '$cidade', '$estado', '$redesocial', '$pergunta1', '$time', '$pergunta2', '$doacao', '$valor', '$obs', '$data','$modificado, '$usuario')");

	$result_doacao = mysqli_query($conexao, "INSERT INTO doacoes(data, doador, cpf_doador, valor, doacao, usuario) VALUES('$data_doacao', '$nome', '$cpf', '$valor', '$modificado', '$usuario')");
	...
	/* Script com notificação de cadastro realizado com sucesso, após o cadastro retorna pra tela de mantenedores */
